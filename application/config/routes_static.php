...
//convert
//$route['request-quote']['POST'] = 'bidding_controller/request_quote';
$route['submit-convert-post']['POST'] = 'admin_controller/submit_convert_post';
$route['accept-convert-post']['POST'] = 'convert_file_controller/accept_convert';
$route['reject-convert-post']['POST'] = 'convert_file_controller/reject_convert';
//ajax
...
$route['add-to-cart-file']['POST'] = 'cart_controller/add_to_cart_file';
...
$route['download-purchased-digital-convert-file-post']['POST'] = 'file_controller/download_purchased_digital_file_convert';
$route['download-free-digital-file-post']['POST'] = 'file_controller/download_free_digital_file';
$route['download-demo-file']['POST'] = 'file_controller/download_convert_demo_file';
//product
...
$route['convert-post']['POST'] = 'home_controller/convert_post';
