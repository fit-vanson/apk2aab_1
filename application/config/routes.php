...
foreach ($languages as $language) {
    if ($language->status == 1) {
        ...
        /*convert*/
        $route[$key . getr('convert', $rts)]['GET'] = 'home_controller/convert';
        /*messages*/
        ...
        /*convert*/
        $route[$key . getr('convert_files_requests', $rts)]['GET'] = 'convert_file_controller/convert_files_requests';
        /*terms-conditions*/
        ...
        $route[$key . getr('dashboard', $rts) . '/' . getr('convert_files', $rts)]['GET'] = 'dashboard_controller/convert_files';
...
/*convert system*/
$route[getr('admin', $rts) . '/convert-files'] = 'admin_controller/convert_files';
$route[getr('admin', $rts) . '/submit-convert-post']['POST'] = 'admin_controller/submit_convert_post';
