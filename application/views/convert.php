            ...
            <div class="col-12">
                <nav class="nav-breadcrumb" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo trans("convert"); ?></li>
                    </ol>
                </nav>
                <h1 class="page-title"><?php echo trans("convert"); ?></h1>
            </div>
                ...
                <div class="page-contact">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12 order-1 order-lg-0">
                            ...
                            <!-- form start -->
                            <?php echo form_open_multipart('convert-post', ['id' => 'form_validate', 'class' => 'validate_terms']); ?>
                            <input type="text" name="convert_url" class="ctd">
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control form-input" name="email" maxlength="199" placeholder="<?php echo trans("email_address"); ?>" value="<?php echo $this->session->userdata('mds_sess_user_email'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                            </div>
                            ...
                            <div class="form-group hidden">
                                <div class="custom-control custom-checkbox custom-control-validate-input">
                                    <input type="checkbox" class="custom-control-input" name="terms" id="checkbox_terms" checked>
