    ...
    <aside class="main-sidebar" style="background-color: #343B4A;">
        <section class="sidebar sidebar-scrollbar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                if (has_permission('convert_files')):?>
                    <li class="nav-convert-files">
                        <a href="<?php echo admin_url(); ?>convert-files">
                            <i class="fa fa-exchange"></i> <span><?php echo trans("convert_files"); ?></span>
                        </a>
                    </li>
                <?php endif;
