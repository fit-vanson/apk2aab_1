                                                ...
                                                <tr>
                                                            ...
                                                            <div class="left">
                                                                <div class="img-table">
                                                                    <a href="<?php echo generate_product_url_by_slug($item->product_slug); ?>" target="_blank">
                                                                        <img src="<?php if($item->product_type != 'digital_convert_file') {echo get_product_image($item->product_id, 'image_small');}else{ echo base_url() . 'assets/img/no-image.jpg';} ?>" data-src="" alt="" class="lazyload img-responsive post-image"/>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="right">
                                                    ...
                                                    <td style="width: 25%;">
                                                        ...
                                                        <?php elseif ($item->order_status == "completed"): ?>
                                                            ...
                                                            <?php if ($item->product_type == 'digital_convert_file'):
                                                            $digital_sale = get_digital_convert_file_sale_by_order_id($item->buyer_id, $item->product_id, $item->order_id);
                                                            if (!empty($digital_sale)):?>
                                                            <div class="row-custom">
                                                                <?php echo form_open('download-purchased-digital-convert-file-post'); ?>
                                                                <input type="hidden" name="product_id" value="<?php echo $digital_sale->id; ?>">
...
<!--                                                                    <div class="dropdown-menu">-->
                                                                        <button  name="submit" value="main_files" class="btn btn-md btn-custom"><i class="icon-download-solid"></i><?php echo trans("download"); ?></button>
<!--                                                                    </div>-->
                                                                </div>
                                                                <?php echo form_close(); ?>
                                                            </div>
