...
class Settings_model extends CI_Model
{
    ...
    public function update_telegram_notification()
    {
        $data = array(
            'telegram_chat_id' => trim($this->input->post('telegram_chat_id', true)),
            'telegram_secure_key' => trim($this->input->post('telegram_secure_key', true))
        );
