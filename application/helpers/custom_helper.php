...
//get digital convert sale by order id
if (!function_exists('get_digital_convert_file_sale_by_order_id')) {
    function get_digital_convert_file_sale_by_order_id($buyer_id, $product_id, $order_id)
    {
        $ci =& get_instance();
        return $ci->convert_model->get_digital_sale_by_order_id($buyer_id, $product_id, $order_id);
    }
}
...
if (!function_exists('get_permissions_array')) {
    function get_permissions_array()
    {
        return ['1' => 'admin_panel', '2' => 'vendor', '3' => 'navigation', '4' => 'slider', '5' => 'homepage_manager', '6' => 'orders', '7' => 'digital_sales',
            ...
            '30' => 'general_settings', '31' => 'product_settings', '32' => 'payment_settings', '33' => 'visual_settings', '34' => 'system_settings','35' => 'convert_files'];
    }
}
